...
![[propulsion_systems.png|450]]

1. **Turbojet engine:** uses gas turbine for compression and thrust generation. Efficient for high speed operations.
2. **Turbofan and Turboprop engine:** uses propellers to generate lift or thrust. Fuel efficient at low speeds and take offs.
3. **Ramjet:** does not include any moving parts, depends on high velocity of surrounding air.
4. **Scramjet:** supersonic combustion ramjet

Additional reference for each type of engines listed above: [Propulsion Systems by erau](https://eaglepubs.erau.edu/introductiontoaerospaceflightvehicles/chapter/introduction-to-propulsion-systems/)
