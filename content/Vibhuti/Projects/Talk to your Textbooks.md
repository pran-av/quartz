...
**What do we need to build to achieve this?**
1. Upload certain chapters - parse and index them
2. A UI where learner can select a chapter and start the conversation
3. A system where customer can request practice
4. Ability to generate practice based on what they have already learnt

Before starting on the first task, let's understand the [[Retrieval Augmented Generation]]
