...
>[!warning] Information for Knowledge Purpose Only
...
1. Electrostatic Attraction: CHG is positively charged and is attracted to negatively charged bacteria and fungi.
2. Membrane Disruption: Either makes the cell wall permeable leading to leakage of cell materials or coagulates the cytoplasm inside the cell.
3. Persistence: Remains active for a long period of time and hence preferred widely.
...
Its a strong base compared to solutions on environments it is used in ($pH$ of human body is $7.4$). The dissociation constant ($pKa$) is $10.8$ allowing it to gain Hydrogen ions ($H^+$).

CHG structure is symmetrical with a chain in middle and two biguanide groups at either end. Each of this group accepts a proton giving the entire molecule a ($2^+$) charge.