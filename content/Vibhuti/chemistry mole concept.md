...
Volume $\propto$ number of particles
...
$Volume\propto Mass/Density$

# Avogadro's Constant

Based on the Avogadro's Law, **Johann Josef Loschmidt in 1865** estimated the number of particles in a given volume of gas.

The precise value of number of particles in a given volume was determined by **Jean Baptiste Perrin in 190**9 during his Brownian Motion experiments. Jean attributed this constant number as 'Avogadro's Constant'. Jean was awarded a Nobel Prize in Physics for his contributions.

So now we know,

**$N_A=6.02214076\times10^{23}$** 

Unlike the law, being a constant, $N_A$ applies across all states of matters like solid, liquid, and gases.

# Mole

Finally we comes to the concept of 'mole'. 

So mole is a made up concept by us humans, same as kilogram and every other measure. We say 1 mole is same as the number of atoms in 12g of $C^{12}$, which is equal to the Avogadro's Constant of $6.02214076\times10^{23}$.

So 1 mole of any entity (say it be atoms, molecules, ions, or even grains of rice) would be equal to $6.02214076\times10^{23}$.

However we use this unit specifically for atomic or molecular measures as 1 mole of rice if calculated would be $1.5×10^{19} kg$ which is absurd. Hence we stick to kilograms for rice.
